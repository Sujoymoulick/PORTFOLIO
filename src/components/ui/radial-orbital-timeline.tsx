                ...
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-64 bg-black/90 backdrop-blur-lg border-white/30 shadow-xl shadow-white/10 overflow-visible">
                    ...
                    <CardHeader className="pb-2">
                      ...
                      <CardTitle className="text-sm mt-3 font-serif font-medium">
                        {item.title}
                      </CardTitle>
                    </CardHeader>
                    <CardContent className="text-[11px] text-white/80 leading-relaxed">
                      ...
                      <div className="mt-4 pt-3 border-t border-white/10">
                        <div className="flex justify-between items-center text-[10px] uppercase font-bold tracking-tighter mb-1">
                      ...
                      {item.relatedIds.length > 0 && (
                        <div className="mt-4 pt-3 border-t border-white/10">
                          <div className="flex items-center mb-2">
                            ...
                            <h4 className="text-[10px] uppercase tracking-wider font-bold text-white/70">
                              Connected Nodes
                            </h4>
                          </div>
                            ...
                            {item.relatedIds.map((relatedId) => {
                              ...
                              return (
                                <Button
                                  ...
                                  variant="outline"
                                  size="sm"
                                  className="flex items-center h-6 px-2 py-0 text-[9px] rounded-none border-white/20 bg-transparent hover:bg-white/10 text-white/80 hover:text-white transition-all uppercase tracking-widest font-bold"
                                  onClick={(e) => {
                                    e.stopPropagation();
