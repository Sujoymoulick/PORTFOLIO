...
export function CinematicHero({ 
  ...
  tagline2 = "one block at a time.",
  cardHeading = "Code becomes art.",
  cardDescription = <><span className="text-white font-semibold">Sujoy</span> is a developer specializing in AI, Web3, and interactive 3D experiences. Transforming imagination into digital reality with precision and passion.</>,
  metricValue = 12,
  metricLabel = "Projects Built",
  ctaHeading = "Let's collaborate.",
  ctaDescription = "Join me in building the next generation of decentralized and intelligent web experiences.",
  className, 
  ...props 
}: CinematicHeroProps) {
    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6">
          <a 
            href="https://www.linkedin.com/in/sujoymoulick/" 
            target="_blank" 
            rel="noopener noreferrer"
            aria-label="Connect on LinkedIn" 
            className="btn-modern-light flex items-center justify-center gap-4 px-10 py-5 rounded-[1.5rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
            <Linkedin className="w-8 h-8 text-[#0077B5] transition-transform group-hover:scale-110" fill="currentColor" stroke="none" />
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-widest text-neutral-500 uppercase mb-[-2px]">Professional</div>
              <div className="text-xl font-bold leading-none tracking-tight">LinkedIn</div>
            </div>
          </a>
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            aria-label="Explore projects on GitHub" 
            className="btn-modern-dark flex items-center justify-center gap-4 px-10 py-5 rounded-[1.5rem] group focus:outline-none focus:ring-2 focus:ring-neutral-400 focus:ring-offset-2"
          >
            <Github className="w-8 h-8 text-white transition-transform group-hover:scale-110" />
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-widest text-neutral-400 uppercase mb-[-2px]">Explore projects</div>
              <div className="text-xl font-bold leading-none tracking-tight text-white">GitHub</div>
            </div>
          </a>
        </div>
      </div>
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Insights</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">SM</div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500/20 to-purple-600/5 flex items-center justify-center mr-3 border border-purple-400/20 shadow-inner">
                            <svg className="w-4 h-4 text-purple-400 drop-shadow-md" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a2 2 0 00-1.96 1.414l-.727 2.903a2 2 0 01-3.866 0l-.727-2.903a2 2 0 00-1.96-1.414l-2.387.477a2 2 0 00-1.022.547l-2.387 2.387a2 2 0 11-2.828-2.828l2.387-2.387a2 2 0 00.547-1.022l.477-2.387a2 2 0 00-1.414-1.96L4.727 9.53a2 2 0 010-3.866l2.903-.727a2 2 0 001.414-1.96l.477-2.387a2 2 0 112.828-2.828l2.387 2.387a2 2 0 001.022.547l2.387.477a2 2 0 001.96-1.414l.727-2.903a2 2 0 013.866 0l.727 2.903a2 2 0 001.96 1.414l2.387-.477a2 2 0 001.022-.547l2.387-2.387a2 2 0 112.828 2.828l-2.387 2.387z" />
                            </svg>
                          </div>
                          <div className="flex-1">
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">AI Agent Ready</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Deployment active</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Web3 Verified</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">On-chain identity</p>
                  </div>
                </div>
