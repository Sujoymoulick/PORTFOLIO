  ...
  return (
    <div className="flex items-center justify-center h-full gap-2">
      {shields.map((shield) => (
        ...
        >
          <ShieldCheck className={`w-5 h-5 ${shield.active ? 'text-white' : 'text-gray-600'}`} />
        </motion.div>
      ))}
    </div>
  )
    ...
    <div className="grid grid-cols-1 md:grid-cols-6 gap-4 auto-rows-[200px]">
      ...
      >
        ...
        <div className="mt-auto relative z-20 bg-zinc-900/50 backdrop-blur-sm rounded-lg p-2">
          ...
          <p className="text-gray-400 text-sm mt-1">Lightning-fast content delivery worldwide.</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="mt-4">
          ...
          <p className="text-gray-400 text-sm mt-1">Enterprise-grade encryption.</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="mt-4">
          ...
          <p className="text-gray-400 text-sm mt-1">Optimized for all devices.</p>
        </div>
      </motion.div>
