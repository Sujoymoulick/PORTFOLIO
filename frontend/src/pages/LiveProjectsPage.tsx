...
import { ArrowLeft, ExternalLink, Globe, Code2, Cpu, Rocket, Heart, ArrowRight, GitPullRequest } from 'lucide-react';
...
const LIVE_PROJECTS = [
  {
    ...
    description: 'FuncPilot is an automated code testing and reporting platform designed to help developers validate functions efficiently. The tool scans source code files, identifies available functions, executes test cases, detects errors and unexpected behavior, and generates detailed reports in a clean, developer-friendly format. It helps improve code reliability and reduces debugging time.',
  ...
  },
  {
    ...
    description: 'README Smith is a smart README generator that helps developers create professional GitHub profile and repository READMEs. It provides customizable templates, structured sections, and markdown generation tools, allowing users to build attractive and informative GitHub profiles within minutes.',
  ...
  },
  {
    ...
    description: 'Listing Expert is a Chrome Web Store optimization toolkit built to simplify the extension publishing process. It assists developers in generating listing content, formatting descriptions, preparing store assets, and following Chrome Web Store guidelines, making extension publishing faster and more efficient.',
    tags: ['JavaScript', 'Chrome Extensions API', 'SEO Utilities'],
  ...
  },
  {
    ...
    description: 'EchoToDo is a productivity-focused Chrome extension designed to help users stay organized and focused. It includes customizable timers, task tracking features, and tab-based activity management, allowing users to assign tasks to specific browser tabs and monitor their progress efficiently. The extension is currently published and available on the Chrome Web Store.',
    tags: ['JavaScript', 'Chrome Extensions API', 'Local Storage'],
  ...
  },
  {
    ...
    description: 'ChangeOrbit is a GitHub commit log management tool that transforms raw commit histories into a clean, organized, and easy-to-read format. It helps developers track project progress, review development activity, and visualize repository changes more effectively.',
    tags: ['JavaScript', 'GitHub API', 'HTML', 'CSS'],
  ...
  },
  {
    ...
    description: 'Weblixio is a browser utility extension that extracts website design information such as theme colors, color palettes, and visual styling elements. Users can capture these details and export them into a structured PDF report for design reference, branding analysis, or development purposes.',
    tags: ['JavaScript', 'WebExtensions API', 'PDF Generation'],
              ...
              <div>
                ...
                <div className="flex justify-between items-center mt-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 text-[10px] font-bold uppercase tracking-widest text-white/40 hover:text-white transition-colors cursor-pointer"
                  >
                    Contribute <GitPullRequest size={10} />
                  </button>
                </div>
              </div>
            </motion.div>
