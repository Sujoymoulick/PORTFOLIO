      ...
      <main className="relative z-10 pt-32 pb-20 max-w-4xl mx-auto px-6">
        ...
        <footer className="mt-32 pt-12 border-t border-white/5 text-center">
          <div className="flex flex-wrap justify-center gap-6 mb-8">
            ...
            <Link to="/privacy-policy" className="text-[10px] font-bold text-white uppercase tracking-widest hover:text-blue-400 transition-colors">Privacy Policy</Link>
            <Link to="/terms" className="text-[10px] font-bold text-white/40 uppercase tracking-widest hover:text-white transition-colors">Terms</Link>
